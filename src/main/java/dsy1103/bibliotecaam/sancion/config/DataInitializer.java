...
public class DataInitializer implements CommandLineRunner{
    ...
    public void run(String... args) {
        ...
        sancionRepository.save(new Sancion(null, LocalDate.of(2006,07,20), 50000,          "No pago en el plazo de vencimiento de su prestamo.", true));
        ...
        sancionRepository.save(new Sancion(null, LocalDate.of(2010,02,30), 35000,          "No pago en el plazo de vencimiento de su prestamo.", false));
